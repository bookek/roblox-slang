...
function Translations._setupNamespaces(self)
	...
	self.confirmation.cancel = function()
		return self:confirmation_cancel()
	end
	self.confirmation.code = function(_, ...)
		return self:confirmation_code(...)
	end
	self.confirmation.confirm = function()
		return self:confirmation_confirm()
	end
	self.confirmation.failed = function()
		return self:confirmation_failed()
	end
	self.confirmation.guest = function()
		return self:confirmation_guest()
	end
	self.confirmation.host = function()
		return self:confirmation_host()
	end
	self.confirmation.invite = function()
		return self:confirmation_invite()
	end
	self.confirmation.kick = function()
		return self:confirmation_kick()
	end
	self.confirmation.layout = function(_, ...)
		return self:confirmation_layout(...)
	end
	self.confirmation.need_more = function(_, ...)
		return self:confirmation_need_more(...)
	end
	self.confirmation.player_count = function(_, ...)
		return self:confirmation_player_count(...)
	end
	self.confirmation.ready = function()
		return self:confirmation_ready()
	end
	self.confirmation.room_title_placeholder = function(_, ...)
		return self:confirmation_room_title_placeholder(...)
	end
	self.confirmation.saved = function()
		return self:confirmation_saved()
	end
	self.confirmation.settings = function()
		return self:confirmation_settings()
	end
	self.confirmation.starting = function()
		return self:confirmation_starting()
	end
	self.errors.connection_lost = function()
		return self:errors_connection_lost()
	end
	self.errors.failed_to_connect = function()
		return self:errors_failed_to_connect()
	end
	self.errors.invalid_code = function()
		return self:errors_invalid_code()
	end
	self.errors.permission_denied = function()
		return self:errors_permission_denied()
	end
	self.errors.room_full = function()
		return self:errors_room_full()
	end
	self.errors.timeout = function()
		return self:errors_timeout()
	end
	self.errors.unknown = function()
		return self:errors_unknown()
	end
	self.loading.connecting = function()
		return self:loading_connecting()
	end
	self.loading.discovering = function()
		return self:loading_discovering()
	end
	self.loading.downloading = function()
		return self:loading_downloading()
	end
	self.loading.finalizing = function()
		return self:loading_finalizing()
	end
	self.loading.initializing = function()
		return self:loading_initializing()
	end
	self.loading.items.one = function()
		return self:loading_items_one()
	end
	self.loading.items.other = function(_, ...)
		return self:loading_items_other(...)
	end
	self.loading.items.zero = function()
		return self:loading_items_zero()
	end
	self.loading.joining_room = function()
		return self:loading_joining_room()
	end
	self.loading.loading_assets = function(_, ...)
		return self:loading_loading_assets(...)
	end
	self.loading.loading_room = function()
		return self:loading_loading_room()
	end
	self.loading.preparing_controls = function()
		return self:loading_preparing_controls()
	end
	self.loading.preparing_room = function()
		return self:loading_preparing_room()
	end
	self.loading.ready = function()
		return self:loading_ready()
	end
	self.loading.starting_room = function()
		return self:loading_starting_room()
	end
	self.loading.subtitle = function()
		return self:loading_subtitle()
	end
	self.loading.title = function()
		return self:loading_title()
	end
	self.loading.verifying = function()
		return self:loading_verifying()
	end
	self.lobby.create_room = function()
		return self:lobby_create_room()
	end
	self.lobby.failed_load = function()
		return self:lobby_failed_load()
	end
	self.lobby.filter_by = function(_, ...)
		return self:lobby_filter_by(...)
	end
	self.lobby.join_room = function()
		return self:lobby_join_room()
	end
	self.lobby.no_rooms = function()
		return self:lobby_no_rooms()
	end
	self.lobby.refresh = function()
		return self:lobby_refresh()
	end
	self.lobby.room_count = function(_, ...)
		return self:lobby_room_count(...)
	end
	self.lobby.search_placeholder = function()
		return self:lobby_search_placeholder()
	end
	self.lobby.sort_by = function(_, ...)
		return self:lobby_sort_by(...)
	end
	self.room.chat.clear = function()
		return self:room_chat_clear()
	end
	self.room.chat.joined = function(_, ...)
		return self:room_chat_joined(...)
	end
	self.room.chat.left = function(_, ...)
		return self:room_chat_left(...)
	end
	self.room.chat.muted = function()
		return self:room_chat_muted()
	end
	self.room.chat.placeholder = function()
		return self:room_chat_placeholder()
	end
	self.room.chat.send = function()
		return self:room_chat_send()
	end
	self.room.chat.system = function()
		return self:room_chat_system()
	end
	self.room.controls.mute = function()
		return self:room_controls_mute()
	end
	self.room.controls.pause = function()
		return self:room_controls_pause()
	end
	self.room.controls.resume = function()
		return self:room_controls_resume()
	end
	self.room.controls.settings = function()
		return self:room_controls_settings()
	end
	self.room.controls.start = function()
		return self:room_controls_start()
	end
	self.room.controls.stop = function()
		return self:room_controls_stop()
	end
	self.room.controls.unmute = function()
		return self:room_controls_unmute()
	end
	self.room.controls.volume = function(_, ...)
		return self:room_controls_volume(...)
	end
	self.room.info.duration = function(_, ...)
		return self:room_info_duration(...)
	end
	self.room.info.layout = function(_, ...)
		return self:room_info_layout(...)
	end
	self.room.info.leave_failed = function()
		return self:room_info_leave_failed()
	end
	self.room.info.leaving = function()
		return self:room_info_leaving()
	end
	self.room.info.live = function()
		return self:room_info_live()
	end
	self.room.info.paused = function()
		return self:room_info_paused()
	end
	self.room.info.recording = function()
		return self:room_info_recording()
	end
	self.room.info.title = function(_, ...)
		return self:room_info_title(...)
	end
	self.room.info.unknown = function()
		return self:room_info_unknown()
	end
	self.room.info.viewers = function(_, ...)
		return self:room_info_viewers(...)
	end
	self.settings.audio.echo_cancellation = function()
		return self:settings_audio_echo_cancellation()
	end
	self.settings.audio.input_device = function()
		return self:settings_audio_input_device()
	end
	self.settings.audio.noise_suppression = function()
		return self:settings_audio_noise_suppression()
	end
	self.settings.audio.output_device = function()
		return self:settings_audio_output_device()
	end
	self.settings.audio.quality = function()
		return self:settings_audio_quality()
	end
	self.settings.audio.title = function()
		return self:settings_audio_title()
	end
	self.settings.audio.volume = function()
		return self:settings_audio_volume()
	end
	self.settings.general.auto_join = function()
		return self:settings_general_auto_join()
	end
	self.settings.general.language = function()
		return self:settings_general_language()
	end
	self.settings.general.notifications = function()
		return self:settings_general_notifications()
	end
	self.settings.general.theme = function()
		return self:settings_general_theme()
	end
	self.settings.general.title = function()
		return self:settings_general_title()
	end
	self.settings.video.brightness = function()
		return self:settings_video_brightness()
	end
	self.settings.video.camera = function()
		return self:settings_video_camera()
	end
	self.settings.video.framerate = function()
		return self:settings_video_framerate()
	end
	self.settings.video.resolution = function()
		return self:settings_video_resolution()
	end
	self.settings.video.title = function()
		return self:settings_video_title()
	end
	self.test.farewell = function()
		return self:test_farewell()
	end
	self.test.greeting = function()
	...
	self.ui.labels.another_multiline = function()
		return self:ui_labels_another_multiline()
	end
	self.ui.labels.loading = function(_, ...)
		return self:ui_labels_loading(...)
	end
	self.ui.labels.multiline_test = function()
		return self:ui_labels_multiline_test()
	end
	self.ui.labels.player_count = function(_, ...)
		return self:ui_labels_player_count(...)
	end
	self.ui.labels.room_code = function(_, ...)
		return self:ui_labels_room_code(...)
	end
